...
Estimated hours spent reviewing: 3h, 9h12
...
-   In the section ‘Compatibility with `openair`’: I do not have
    ...
    qualR. So I think it woulb be a good idea to write in the vignette,
...
-   The names of the columns of the datasets generated are not following
    a style guide. \[…\] Language,
